      ...
      <section className="news" id="notas">
        ...
        <div className="wrap news-list">
          <article className="news-item">
            <p className="news-date">14 jun 2026</p>
            <div>
              <p className="news-title">Por qué el coleccionismo está dejando las ferias masivas y volviendo a lo íntimo</p>
              <p className="news-excerpt">Cada vez más compradores prefieren conocer la historia detrás de una pieza antes que recorrer un pabellón de 400 stands.</p>
            </div>
          </article>
          <article className="news-item">
            <p className="news-date">02 jun 2026</p>
            <div>
              <p className="news-title">Cinco materiales que están reapareciendo en el arte contemporáneo</p>
              <p className="news-excerpt">Del pigmento mineral molido a mano al collage de archivo: una mirada a las técnicas que vuelven a ganar terreno.</p>
            </div>
          </article>
          <article className="news-item">
            <p className="news-date">15 may 2026</p>
            <div>
              <p className="news-title">Cómo se calcula una puja mínima cuando el artista recién empieza</p>
              <p className="news-excerpt">Tamaño, materiales, horas y trayectoria: una guía simple para artistas que están por subastar su primera pieza.</p>
            </div>
          </article>
        </div>
      </section>
