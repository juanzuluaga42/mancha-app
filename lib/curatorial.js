...
export const OUTCOMES = [
  ...
  { value: 'second_round', label: 'A segunda ronda', labelEn: 'To a second round', desc: 'Vuelve a revisión con otra mirada.',       descEn: 'Returns to review with another look.' },
  { value: 'hold',         label: 'En reserva',      labelEn: 'On hold',          desc: 'Queda pendiente para más adelante.',       descEn: 'Kept pending for later.' },
