...
export const artistas = [
  ...
  { n: 12, nombre: 'Pablo Picasso', anos: '1881–1973', mov: 'Cubismo', pais: 'España', color: 'var(--red)', obra: 'Guernica', img: null, desc: 'Reinventó la pintura más de una vez. Cofundó el cubismo y, con "Guernica", hizo del arte un grito político imposible de ignorar.' },
  { n: 13, nombre: 'Henri Matisse', anos: '1869–1954', mov: 'Fauvismo', pais: 'Francia', color: 'var(--red)', obra: 'La danza', img: null, desc: 'El maestro del color puro y la línea libre. En la vejez, sin poder pintar, inventó los recortes de papel: arte con tijeras.' },
  { n: 14, nombre: 'Marcel Duchamp', anos: '1887–1968', mov: 'Dadaísmo', pais: 'Francia', color: 'var(--ink)', obra: 'La fuente', img: null, desc: 'Puso un urinario en una galería y firmó "R. Mutt". Con ese gesto preguntó qué es el arte — y el arte conceptual no volvió a ser igual.' },
  { n: 15, nombre: 'Frida Kahlo', anos: '1907–1954', mov: 'Surrealismo / Folk', pais: 'México', color: 'var(--lilac)', obra: 'Las dos Fridas', img: null, desc: 'Convirtió el dolor físico y emocional en un lenguaje visual propio. Sus autorretratos son hoy un emblema global de identidad y resistencia.' },
  { n: 16, nombre: 'Salvador Dalí', anos: '1904–1989', mov: 'Surrealismo', pais: 'España', color: 'var(--lilac-deep)', obra: 'La persistencia de la memoria', img: null, desc: 'El showman del subconsciente. Sus relojes blandos volvieron cotidiano lo onírico, y él mismo se convirtió en obra de arte y personaje.' },
  { n: 17, nombre: 'Georgia O\'Keeffe', anos: '1887–1986', mov: 'Modernismo americano', pais: 'EE. UU.', color: 'var(--red-deep)', obra: 'Flores y desiertos', img: null, desc: 'La madre del modernismo estadounidense. Sus flores monumentales y los paisajes de Nuevo México redefinieron la mirada sobre la naturaleza.' },
  { n: 18, nombre: 'Jackson Pollock', anos: '1912–1956', mov: 'Expresionismo abstracto', pais: 'EE. UU.', color: 'var(--ink)', obra: 'Number 1A', img: null, desc: 'El "dripping": pintar goteando sobre el lienzo en el suelo, con todo el cuerpo. Liberó a la pintura del caballete y del control.' },
  { n: 19, nombre: 'Andy Warhol', anos: '1928–1987', mov: 'Pop Art', pais: 'EE. UU.', color: 'var(--lilac)', obra: 'Latas de sopa Campbell', img: null, desc: 'Borró la frontera entre arte y consumo. Sopas, billetes y celebridades repetidas en serie: el espejo perfecto del siglo del marketing.' },
  { n: 20, nombre: 'Jean-Michel Basquiat', anos: '1960–1988', mov: 'Neoexpresionismo', pais: 'EE. UU.', color: 'var(--red)', obra: 'Untitled (1982)', img: null, desc: 'Pasó del grafiti en el Lower East Side a romper récords de subasta. Murió a los 27. Primer artista negro en alcanzar el centro del mercado.' },
];
