...
export const artistas = [
  ...
  { n: 13, nombre: 'Henri Matisse', anos: '1869–1954', mov: 'Fauvismo', pais: 'Francia', color: 'var(--red)', obra: 'La danza', img: wiki('Grande_odalisque_à_la_culotte_bayadère_-_Henri_Matisse.jpg'), desc: 'El maestro del color puro y la línea libre. En la vejez, sin poder pintar, inventó los recortes de papel: arte con tijeras.' },
