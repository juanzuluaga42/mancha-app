...
export const artistas = [
  ...
  { n: 13, nombre: 'Henri Matisse', anos: '1869–1954', mov: 'Fauvismo', pais: 'Francia', color: 'var(--red)', obra: 'La danza', img: wiki('La danse (Matisse).jpg'), desc: 'El maestro del color puro y la línea libre. En la vejez, sin poder pintar, inventó los recortes de papel: arte con tijeras.' },
  ...
  { n: 18, nombre: 'Jackson Pollock', anos: '1912–1956', mov: 'Expresionismo abstracto', pais: 'EE. UU.', color: 'var(--ink)', obra: 'Number 1A', img: wiki('Hans Namuth - Jackson Pollock.jpg'), desc: 'El "dripping": pintar goteando sobre el lienzo en el suelo, con todo el cuerpo. Liberó a la pintura del caballete y del control.' },
