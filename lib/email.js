...
export function brandedEmail({ heading, lead, paragraphs = [], cta, note, signoff = 'MANCHA', preheader = '', locale = 'es' } = {}) {
  const en = locale === 'en';
  const tagline = en ? 'Emerging art gallery' : 'Galería de arte emergente';
  const footerLine = en ? 'What you see here, you saw before the world.' : 'Lo que ves aquí, lo viste antes que el mundo.';
  const leadHtml = lead
  ...
  <tr><td align="center" style="padding:36px 16px;">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#FAF3E6;">
      ...
      <tr><td style="background:#16110D;padding:30px 40px;">
        ...
        <div style="font-family:${SANS};font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#8c8378;margin-top:8px;">${tagline}</div>
      </td></tr>
      <!-- Cuerpo -->
      ...
      <tr><td style="background:#16110D;padding:24px 40px;">
        ...
        <div style="font-family:${SANS};font-size:11px;color:#5a5249;margin-top:10px;">${footerLine}</div>
      </td></tr>
    </table>
  </td></tr>
</table>
